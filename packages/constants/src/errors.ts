type ErrorCodes = Record<number, string | { error: string, humanReadable: string }>

// todo: weed out the user only errors, and add human readable versions of the rest

/**
 * Error codes for the Discord API.
 */
const Errors = {
  10001: "Unknown Account",
  10002: {
    error: "Unknown Application",
    humanReadable: "The application you tried to fetch/edit does not exist."
  },
  10003: {
    error: "Unknown Channel",
    humanReadable: "The channel you tried to access/edit does not exist or you don't have permission to view it."
  },
  10004: {
    error: "Unknown Guild",
    humanReadable: "The server you tried to access/edit does not exist or you don't have permission to view it."
  },
  10005: "Unknown Integration",
  10006: "Unknown Invite",
  10007: {
    error: "Unknown Member",
    humanReadable: "The user you tried to access/edit does not exist or you don't have permission to view it."
  },
  ...
  50265: "Pin permission already migrated",
  ...
  260012: "You are not marked as a previewer for this quest. Please add yourself or request to be added as a previewer in the ads manager portal.",
  ...
  340019: "USER_GUILD_JOIN_LARGE_GUILD_UNDERAGE_DISALLOWED (UNKNOWN)",
